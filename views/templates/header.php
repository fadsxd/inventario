	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="<?php echo BASE_URL; ?>assets/images/logohf.png" class="logo-icon" alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">Importadora Humfer</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
                ...
                <li>
					...
					<ul>
						<li> <a href="<?php echo BASE_URL.'usuarios'; ?>"><i class="fa-regular fa-hand-point-right"></i>&nbsp; Usuarios</a>
						</li>
						<li> <a href="<?php echo BASE_URL.'admin/datos';?>"><i class="fa-regular fa-hand-point-right"></i>&nbsp; Configuración</a>
				...
				<li>
					...
					<ul>
						<li> <a href="<?php echo BASE_URL.'medidas'; ?>"><i class="fa-regular fa-hand-point-right"></i>&nbsp; Medidas</a>
						</li>
						<!-- HREF APUNTA AL CONTROLADOR Y POR DEFECTO AL INDEX -->
						<li> <a href="<?php echo BASE_URL.'categorias'; ?>"><i class="fa-regular fa-hand-point-right"></i>&nbsp; Categorias</a>
						</li>
                        <li> <a href="<?php echo BASE_URL.'productos'; ?>"><i class="fa-regular fa-hand-point-right"></i>&nbsp; Productos</a>
						</li>
					</ul>
				</li>
				<li>
                ...
                <li>
					<a href="<?php echo BASE_URL.'proveedor'; ?>">
						<div class="parent-icon"><i class="fa-solid fa-truck-moving"></i>
						</div>
                ...
                <li>
					<a href="widgets.html">
						<div class="parent-icon"><i class="fa-solid fa-calendar"></i>
						</div>
