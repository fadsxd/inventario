...
<div class="card">
    <div class="card-body">
        ...
        <nav class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="categorias-tab" data-bs-toggle="tab" data-bs-target="#nav-categorias" type="button" role="tab" aria-controls="nav-categorias" aria-selected="true">Categorias</button>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active mt-2" id="nav-categorias" role="tabpanel" aria-labelledby="categorias-tab" tabindex="0">
