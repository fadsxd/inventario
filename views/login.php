...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="<?php echo BASE_URL; ?>assets/images/logohf.png" type="image/png" />
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?php echo BASE_URL; ?>assets/images/logo.png" width="250" height="80" alt="" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <form class="row g-3" id="formulario" method="POST" autocomplete="off">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0" id="clave" name="clave" placeholder="Ingrese Contraseña"> 
